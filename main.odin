...
draw_editor_map :: proc(editor: ^LevelEditor) {
	...
	rl.DrawRectangleLines(
		MARGIN + editor.active_tile.x * CELL_SIZE,
		MARGIN + editor.active_tile.y * CELL_SIZE,
		CELL_SIZE,
		CELL_SIZE,
		rl.YELLOW,
	)
...
draw_editor_toolbox :: proc(editor: ^LevelEditor, settings: ^Settings) {
	...
	rl.DrawRectangleLines(
		settings.screen_width - TOOL_SIZE * 2,
		0,
		TOOL_SIZE * 2,
